...
function updatePage(json) {
    ...
    if (json.current.weather[0].main == "Clouds") {
        document.getElementById("background-image").src = '/weatherapp/images/cloudy.jpg';
    } else if (json.current.weather[0].main == "Rain") {
        document.getElementById("background-image").src = '/weatherapp/images/rainy.jpg';
    } else if (json.current.weather[0].main == "Drizzle") {
        document.getElementById("background-image").src = '/weatherapp/images/drizzle.jpg';
    } else if (json.current.weather[0].main == "Snow") {
        document.getElementById("background-image").src = '/weatherapp/images/snowy.jpg';
    } else if (json.current.weather[0].main == "Thunderstorm") {
        document.getElementById("background-image").src = '/weatherapp/images/thunderstorm.jpg';
    }                 
